...
class GaussianDiffusion1DConditional(nn.Module):
    ...
    def p_sample_loop(self, shape, cond, cond_scale = 6., rescaled_phi = 0.7):
        ...
        for t in tqdm(reversed(range(0, self.num_timesteps)), desc = 'sampling loop time step', total = self.num_timesteps):
            ...
            img, x_start = self.p_sample(img, t, cond, cond_scale, rescaled_phi)
    ...
    def ddim_sample(self, shape, cond, cond_scale = 6., rescaled_phi = 0.7, clip_denoised = True):
        ...
        for time, time_next in tqdm(time_pairs, desc = 'sampling loop time step'):
            ...
            #self_cond = x_start if self.self_condition else None
            pred_noise, x_start, *_ = self.model_predictions(img, time_cond, cond, cond_scale, rescaled_phi, clip_x_start = clip_denoised)
    ...
    def sample(self, cond, cond_scale = 6., rescaled_phi = 0.7):
        ...
        return sample_fn((batch_size, channels, seq_length), cond, cond_scale, rescaled_phi)
